...
A clean, precise mathematical graph on a dark background (#111827) showing the exponential disclosure probability curve:
...
Style: Clean academic chart. Precise gridlines. Mathematical notation. Dark theme. Looks like it belongs in a peer-reviewed journal. No decorative elements.

## Specifications
- Dimensions: 1200 x 900 pixels (landscape)
- Style: Mathematical graph, academic, precise
